...
Secrets expected as environment variables (see the notebook launch cell):
...
Admin login shares the same form as user login (Step 11 still applies:
admin credentials are constants/env vars, never a row in the users table).
"""
...
COLORS = {
    "bg_main": "#F7F4ED", "bg_card": "#FFFEFB", "bg_card_alt": "#C7D3C0",
    "text_main": "#454F42", "text_heading": "#3A4238", "text_muted": "#7C8577",
    "accent": "#C8A96B", "accent_hover": "#B8955A", "accent_text": "#3A4238",
    "border": "#DED6C3", "border_strong": "#C8A96B", "danger": "#C0705A",
    "success": "#7A9471",
}
...
<style>
    ...
    html, body, .stApp {{
        background: linear-gradient(180deg, #F7F4ED 0%, #F0ECDF 100%) !important;
    ...
    div[data-testid="stButton"] button {{
        background: linear-gradient(135deg, {COLORS['accent']} 0%, #DCC28C 100%) !important;
    ...
    .pn-hero .logo {{
        ...
        background: linear-gradient(135deg, {COLORS['accent']} 0%, #DCC28C 100%);
    ...
    .dash-banner {{
        background: linear-gradient(120deg, #3A4238 0%, #5C6B54 100%);
...
def send_otp_email(to_email: str, otp: str):
    ...
    html_body = f"""
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;border:2px solid #3A4238;
                border-radius:12px;padding:28px;text-align:center;">
        <h2 style="color:#3A4238;margin-top:0;">{APP_NAME} Verification</h2>
        <p style="color:#4a5568;">Use the code below to reset your password:</p>
        <div style="background:#C8A96B;color:#ffffff;font-size:26px;font-weight:700;letter-spacing:6px;
